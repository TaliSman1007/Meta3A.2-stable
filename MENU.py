...
class MainMenu(Menu):
    ...
    def __init__(self):
        Menu.__init__(self, '')
        self.new_button = Button((SETTINGS.canvas_actual_width/2, 200, 200, 60), "EMAG WEN")
        self.options_button = Button((SETTINGS.canvas_actual_width/2, 270, 200, 60), "SNOITPO")
        self.score_button = Button((SETTINGS.canvas_actual_width/2, 340, 200, 60), "SCITSITATS")
        self.credits_button = Button((SETTINGS.canvas_actual_width/2, 410, 200, 60), "TUOBA")
        self.quit_button = Button((SETTINGS.canvas_actual_width/2, 500, 200, 60), "TIUQ")
...
class NewMenu(Menu):
    ...
    def __init__(self, settings):
        ...
        self.new_button = Button((SETTINGS.canvas_actual_width/2, 200, 200, 60), "EMAG WEN")
        self.tutorial_button = Button((SETTINGS.canvas_actual_width/2, 270, 200, 60), "LAIROTUT")
        self.back_button = Button((SETTINGS.canvas_actual_width/2, 500, 200, 60), "BACK")

        self.loading = TEXT.Text(0,0, "...GNIDAOL", SETTINGS.BLACK, "DUGAFONT.ttf", 74)
...
class OptionsMenu(Menu):
    ...
    def __init__(self, settings):
        Menu.__init__(self, 'SGNITTES')
        self.save = False

        self.strings = ['WOL', 'DEM', 'HGIH']
        self.music_strings = ['FFO', 'DEM', 'HGIH']
...
class CreditsMenu(Menu):
    ...
    def __init__(self):
        ...
        self.maxwellsalmon = TEXT.Text(0,0, 'TALISMAN', SETTINGS.DARKGRAY, "DUGAFONT.ttf", 38)
...
class SupportSplash:
    ...
    def __init__(self):
        ...
        self.pleas = ['You  have  been  playing  META', 'for  over  two  hours  now.  I', 'really  hope  you  enjoy  it.',
